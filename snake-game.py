...
def gameLoop():
    ...
    #foodx = int((random.randint(0,dis_width))/snake_block**2)
    #foody = int((random.randint(0,dis_height))/snake_block**2)
    #while foodx%snake_block != 0:
    #    foodx = random.randint(0,200)
    #while foody%snake_block != 0:
    #    foody = random.randint(0,200)
    #food = [int((random.randint(0,dis_width))/snake_block**2),int((random.randint(0,dis_height)/snake_block**2))]
